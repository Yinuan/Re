...
import com.klcxkj.rs.adapter.GRechangeAdapter;
import com.klcxkj.rs.bo.BaseBo;
import com.klcxkj.rs.bo.CardInfo;
import com.klcxkj.rs.bo.OrderInfo;
import com.klcxkj.rs.bo.RechangeValue;
import com.klcxkj.rs.pay.PayResult;
import com.klcxkj.rs.pay.SignUtils;
...
//	http://211.149.224.58:6002/roadPay/aliPay/getAlipayInfor?PrjID=5&EmployeeName=zs&EmployeeID=1&CardID=1&totalFee=0.01
	private String urlGetAlipayInfor = RSApplication.BASE_URL+"tPrjInfo/getAlipayInfor2?";
//	private String urlGetAlipayInfor = RSApplication.BASE_URL+"tPrjInfo/getAlipayInfor?";
	...
	private void initDataFromIntent() {
		...
		if (mCardInfo!=null){
			prefillMoney.setText(mCardInfo.getAccountMoney()+"元");
			edit_cardID.setText(mCardInfo.getCardID()+"");
			edit_user_name.setText(mCardInfo.getEmployeeName());
			edit_user_balance.setText(mCardInfo.getNCardValue()+"元");  //卡余额
		}
...
//				+ "\"";
	...
	public String sign(String content) {
		return SignUtils.sign(content, StringUtils.RSA_PRIVATE);
	}
