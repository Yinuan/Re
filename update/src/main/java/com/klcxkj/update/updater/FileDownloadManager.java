package com.klcxkj.update.updater;
...
class FileDownloadManager {
    ...
    long startDownload(UpdaterConfig updaterConfig) {
        ...
        req.setDestinationInExternalFilesDir(updaterConfig.getContext(), Environment.DIRECTORY_DOWNLOADS, "Re.apk");
        //第二种
        //file:///storage/emulated/0/Download/update.apk
        req.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "Re.apk");
        ////第三种 自定义文件路径
